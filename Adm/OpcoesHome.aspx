            ...
            <div class="dmenu">
                <div class="cad-esquerda">
                    <ul>
                        ...
                        <li>
                            <asp:LinkButton ID="lbtConteudo" runat="server" Text="Conteúdo" OnClick="ativarVwConteudo"></asp:LinkButton></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="dcont-form">
                    <asp:MultiView ID="mwFormOpcoesHome" runat="server">
                        <asp:View ID="vwFormSlider" runat="server">
                            ...
                            <input id="iValidador" type="text" runat="server" visible="true" />
                            ...
                            <section>
                                ...
                                <br />
                                <asp:Button ID="btnCadImg" runat="server" Text="Inserir Imagem" OnClick="inserirImagem" />
                        ...
                        <asp:View ID="vwFormBox33" runat="server">                           
                            ...
                            <input id="iB33Titulo" runat="server" type="text" placeholder="Título" />
                            <textarea id="taB33Introducao" runat="server" placeholder="Introcução" class="alturainput"></textarea>                            
                            <input id="iB33Valida" type="text" runat="server" visible="true" />
                            <div class="intervaloDatas">
                                <div style="width: 100%;">
                            ...
                            <section>
                                ...
                                <label class="labelinpdate">Escolha o Local onde deverá ser exibida a Imagem</label>
