...
namespace Site
{
    public partial class ContAssoc : System.Web.UI.Page
    {
        ...
        {
            string pAssoc = Request.QueryString["pAssoc"]; //Vem da Home
            if (!Page.IsPostBack)
            {
                if (pAssoc == "68")
                {
                    mwAssociados.ActiveViewIndex = 3;
                }
                else if (pAssoc == "65")
                {
                    mwAssociados.ActiveViewIndex = 0;
                }
            }
        ...
        protected void ativarCartao(object sender, EventArgs e)
        {
            mwAssociados.ActiveViewIndex = 0;
        }
        protected void ativarMedico(object sender, EventArgs e)
        {
            mwAssociados.ActiveViewIndex = 1;
        }
        protected void ativarOdonto(object sender, EventArgs e)
        {
            mwAssociados.ActiveViewIndex = 2;
        }
        protected void ativarJuridico(object sender, EventArgs e)
        {
            mwAssociados.ActiveViewIndex = 3;
        }
        protected void ativarValeCompras(object sender, EventArgs e)
        {
            mwAssociados.ActiveViewIndex = 4;
        }
        protected void ativarTanqueCheio(object sender, EventArgs e)
        {
            mwAssociados.ActiveViewIndex = 5;
        }

        public String montarParaAssociados(int ID) //15-03-2021 15:24 Ajustado em: 30-03-2021 
        {
