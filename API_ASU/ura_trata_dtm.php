<?php
    ...
    $menu                    = $_REQUEST['menu'];
    $urlConsultaSaldoCartao  = 'https://www.asu.com.br/API_ASU/ura_assoc_saldocartao.php';
    $urlConsultaValeAlimento = 'https://www.asu.com.br/API_ASU/ura_assoc_valealimento.php';
