...
{
    public partial class VoceOnLine_New : System.Web.UI.Page
    {
        ...
        public String checaTipoUsuario()
        {
            ...
            retorno =  tipoUsuarioLogado(CodAcesso);
        ...
        public void sairVoceOnline(object sender, EventArgs e)
        {
            ...
            {
                Session.Abandon();
                Response.Redirect("https://www.asu.com.br/");
            }
            else
            {
                checarSessao();
        ...
        {
            //MessageBox.Show("Atualiza Extrato");
        ...
        protected void ativarViews(int usuario, int botoes)
        {
            string codAcesso = Session["CodAcesso"].ToString();

            if (tipoUsuarioLogado(codAcesso) == "Associado")
            {
                mwBotoestopo.ActiveViewIndex = botoes;
                mwAssociado.ActiveViewIndex = usuario;
                
            }
            else
            {
                mwBotoestopo.ActiveViewIndex = botoes;
                mwConveniado.ActiveViewIndex = usuario;
                divSaldo.Attributes["class"] = "oculto";
            }
        }
        //#View Associados
        ...
        public void ativarDadosAssoc(object sender, EventArgs e)
        {
            ...
            carregarDados();
            //secFormDados.Attributes["class"] = "  r";
        ...
        public void Processar_retorno()
        {
            try
            {
                ...
                else
                {
                    ...
                    cArquivo_mostra += "<tr>";
                    cArquivo_mostra += "<td class='tdTitulo' > AUTORIZACAO:</td>";
                    cArquivo_mostra += "<td class='tdDados' >" + CortaZeros(cAutoriza) + "</td>";
                    cArquivo_mostra += "</tr>";
                    cArquivo_mostra += "<tr>";
                    cArquivo_mostra += "<td class='tdTitulo'>Cod.Convênio</td>";
                    cArquivo_mostra += "<td class='tdDados' >" + CortaZeros(cCodConv) + "</td>";
                    cArquivo_mostra += "</tr>";
                    cArquivo_mostra += "<tr>";
                    cArquivo_mostra += "<td class='tdTitulo'>Cartão:</td>";
                    cArquivo_mostra += "<td class='tdDados' >" + cCodCarta + " </td>";
                    cArquivo_mostra += "</tr>";
                    cArquivo_mostra += "<tr>";
                    cArquivo_mostra += "<td class='tdTitulo'>Valor</td>";
                    cArquivo_mostra += "<td class='tdDados' >" + CortaZeros((Convert.ToDecimal(cValor) / 100).ToString("C2")) + "</td>";
                    cArquivo_mostra += "</tr>";
                    cArquivo_mostra += "<tr>";
                    cArquivo_mostra += "<td class='tdTitulo'>Parcelas:</td>";
                    cArquivo_mostra += "<td class='tdDados' >" + cParcela + " </td>";
                    cArquivo_mostra += "</tr>";
                    cArquivo_mostra += "<tr>";
                    cArquivo_mostra += "<td class='tdTitulo'>Data:</td>";
                    cArquivo_mostra += "<td class='tdDados' >" + DateTime.Now + " </td>";
                    cArquivo_mostra += "</tr>";
                    cArquivo_mostra += "<tr>";
                    cArquivo_mostra += "<td class='tdTitulo'>CPF</td>";
                    cArquivo_mostra += "<td id='cpf2' class='tdDados' class='tFontExtrato' >" + cCpfCnpj + "</td>";
                    cArquivo_mostra += "</tr>";
                    ...
                    cArquivo_mostra += "</tr>";
                    cArquivo_mostra += "<tr>";
                    cArquivo_mostra += "<td class='tdTitulo'>Saldo</td>";
                    cArquivo_mostra += "<td class='tdDados' >" + CortaZeros((Convert.ToDecimal(cSaldo) / 100).ToString("C2")) + "</td>";
                    cArquivo_mostra += "</tr>";
                    cArquivo_mostra += "<tr><td colspan='2' class='cvTopico'>.</td></tr>";
                    cArquivo_mostra += "</tbody>";
                    cArquivo_mostra += "</table>";
        ...
        public void ativarVenda(object sender, EventArgs e)
        {
            ativarViews(1, 1);
        }
        public void ativarRelConv(object sender, EventArgs e)
        {
            ativarViews(2, 1);
        }
        public void ativarDadosConv(object sender, EventArgs e)
        {
            ativarViews(3, 1);
            carregarDados();
        }
        public void ativarSenhaConv(object sender, EventArgs e)
        {
            ativarViews(4, 1);
        }
        public void ativarDownloadsConv(object sender, EventArgs e)
        {
            ativarViews(5, 1);
        }

        //View Relatórios Convênio

        public void ativarExtratoConv(object sender, EventArgs e)
        {
            mwRelConv.ActiveViewIndex = 0;
        }
        public void ativarRelEntregaConv(object sender, EventArgs e)
        {
            mwRelConv.ActiveViewIndex = 1;
            carregarData();
        }
        public void ativarFaturaConv(object sender, EventArgs e)
        {
            mwRelConv.ActiveViewIndex = 2;
        }
        public void ativarReimprimeVenda(object sender, EventArgs e)
        {
            mwRelConv.ActiveViewIndex = 3;
        }
        ...
        public String checarPesquisa()
        {
            ...
            if(dados.Rows.Count > 0)
            {
                //msgJava("Tem Pesquisa");
                //MessageBox.Show("Tem Pesquisa");
            }
            else {
                //msgJava("Não tem Pesquisa");
                //MessageBox.Show("Não tem Pesquisa");
                divPesquisa.Attributes["class"] = "oculto";
            }
            ...
            if (ObjDbASU.MsgErro == "")
            {
                if (tCampo == 9 || tCampo == 11)
                {
                    ...
                    string style = "<style> " +
                        ...
                        "tbody tr:nth-child(even) { /*Altera a cor da linha*/" +
        ...
        public void trocarSenhaSite(object sender, EventArgs e)
        {
            ...
            if (checaTipoUsuario() == "Associado")
            {
                codAcesso = Session["idAssoc"].ToString();
                idAssoc = codAcesso;

                //MessageBox.Show(idAssoc);
                ...
                //l = Log
                string l_tabela = " ASSOCLOG "; //Tabela
                string l_campos = " associado, dependen, descricao, detalhe, cnscadusu, cnsaltusu, cnscadmom";  //Campos                            
                string l_valores = String.Format("'" + idAssoc + "'," + //Valores
                                   "'" + idAssoc + "'," +
                                   "'" + "Alteração de Senha ADM" + "'," +
                                   "'" + "Senha Alterada através do Site: Antiga: " + dados.Rows[0]["senha"].ToString() + ", Nova: " + iSenhaConfirma.Value + "'," +
                                   "'" + "Site" + "'," +
                                   "'" + "Site" + "'," +
                ...
                string InsertDate = " INSERT INTO " + l_tabela + " (" + l_campos + " ) VALUES (" + l_valores + ")";
                //MessageBox.Show(InsertDate);            
                ...
                if (ObjDados.MsgErro == "")
                {
                    if (iSenhaAtual.Value == dados.Rows[0]["senha"].ToString())
                    {
                        ...
                        else
                        {
                            ...
                            ObjUpDate.EditRegistro(tabela, valores, condicao);
                            ObjLog.InsertRegistro(l_tabela, l_campos, l_valores);
            ...
            {
                codAcesso = Session["LoginIdConvenio"].ToString();
                idConv = codAcesso;

                //MessageBox.Show(idConv);

                //Acessa dados Conveniados para comparar Senha
                //c = consulta
                string c_tabela = " COCONVEN ";
                string c_campos = " senha_adm ";
                string c_condicao = " WHERE idconven = '" + idConv + "' ";
                ...
                //l = Log
                string l_tabela = " COLOG "; //Tabela
                string l_campos = " convenio, descricao, detalhe, cnscadusu, cnsaltusu, cnscadmom ";  //Campos                            
                string l_valores = String.Format("'" + idConv + "'," + //Valores                                   
                                   "'" + "Alteração de Senha ADM" + "'," +
                                   "'" + "Senha Alterada através do Site: Antiga: " + dados.Rows[0]["senha_adm"].ToString() + ", Nova: " + ISenhaConfirmaConv.Value + "'," +
                                   "'" + "Site" + "'," +
                                   "'" + "Site" + "'," +
                                   "'" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'");
                ...
                if (ObjDados.MsgErro == "")
                {
                    if (iSenhaAtualConv.Value == dados.Rows[0]["senha_adm"].ToString())
                    {
                        if (iSenhaNovaConv.Value != ISenhaConfirmaConv.Value)
                        {
                            lblMsg.Text = "As senhas não conferem, digite-as novamente!!!";
                            iSenhaAtualConv.Focus();
                        }
                        else
                        {
                            //UpDate: Altera Campo Senha
                            string tabela = " COCONVEN ";
                            string valores = " senha_adm = '" + ISenhaConfirmaConv.Value + "' ";
                            string condicao = " idconven = '" + idConv + "' ";
        ...
        public void enviarDadosCorrecao(object sender, EventArgs e)
        {
            ...
            if (checaTipoUsuario() == "Associado")
            {
                assunto = "Dados para Alteração, do(a) Associado(a): " + Session["LoginUsuario"].ToString();
                //cc = "reginaldo@asu.com.br";
                cc = "atendimento@asu.com.br";
            ...
            {
                assunto = "Dados para Alteração, do Conveniado: " + Session["LoginUsuario"].ToString();
                //cc = "reginaldo@asu.com.br";
                cc = "convenios@asu.com.br";

                Dados += "Alteração Solicitada em: " + agora + "<br />";
                Dados += "<section style='width: 70%; margin: 0 auto;'>";
                Dados += "<div style='width: 100%; text-align: left; background-color: #cfcaca; margin: 0;'>";
                Dados += "<p style='text-align: center; background-color: #808080; font-size: 2em; margin: 0; padding: 15px 0 5px 0; color: #fff; '>" + "Dados Cadastrais" + "</p>";
                Dados += "<p>" + iNomeConv.Value + "</p>";
                Dados += "<p>" + "Cpf: " + iCnpj.Value + "</p>";
                Dados += "<p>" + "E-mail: " + iEmailAssoc.Value + "</p>";
                Dados += "<p>" + " Telefone: " + iTelefoneConv.Value + "</p>";
                Dados += "<p>" + " Celular: " + iCelularConv.Value + "</p>";
                Dados += "</div>";
                Dados += "<div style='width: 100%; text-align: left; background-color: #cfcaca; margin: 0;'>";
                Dados += "<p style='text-align: center; background-color: #808080; font-size: 2em; margin: 0; padding: 15px 0 5px 0; color: #fff; '>" + "Dados de Endereço" + "</p>";
                Dados += "<p>" + "Cep: " + iCepConv.Value + "</p>";
                Dados += "<p>" + " Rua: " + iRuaConv.Value + ", " + iNumeroConv.Value + "</p>";
                Dados += "<p>" + "Complemento: " + iComplementConv.Value + "</p>";
                Dados += "<p>" + "Bairro: " + iBairroConv.Value + " - " + iCidadeConv.Value + "/" + iEstadoConv.Value + "</p>";
                Dados += "</div>";
                Dados += "<div style='width: 100%; text-align: left; background-color: #cfcaca; margin: 0;'>";
                Dados += "<p style='text-align: center; background-color: #808080; font-size: 2em; margin: 0; padding: 15px 0 5px 0; color: #fff; '>" + "Dados para Contato" + "</p>";
                Dados += "</div>";
                Dados += "<div style='width: 100%; text-align: left; background-color: #cfcaca; margin: 0;'>";
                Dados += "<p style='text-align: center; background-color: #808080; font-size: 2em; margin: 0; padding: 15px 0 5px 0; color: #fff; '>" + "Dados Bancários" + "</p>";
                Dados += "<p>" + "Banco: " + iBancoConv.Value + "</p>";
                Dados += "<p>" + "Agência: " + iAgenciaConv.Value + "</p>";
                Dados += "<p>" + "Conta Corrente: " + iContaCorrenteConv.Value + " - " + iDigCCConv.Value + "</p>";
                Dados += "</div>";
                Dados += "</section>";
            }
            //lblDados.Text = Dados;
            ...
            if (!String.IsNullOrEmpty(Dados))
            {
                ...
                xRet += "<p>" + Apoio.retorno + "</p>";
                xRet += "</div>";
                xRet += "</div>";
                

                secFormDados.Attributes["class"] = "oculto";
                secFormDadosConv.Attributes["class"] = "oculto";
                
                Apoio.EnviarEmail(para, cc, assunto, Dados);

                msgJava("Retorno: " + Apoio.retorno);
        ...
        //# # # # # # # # Operações Comuns # # # # # # # # #
        protected void buscarCep(object sender, EventArgs e)
        {
        ...
        //# # Operações com Dados do Associado e do Conveniado # #
        public void carregarDados()
        {
            ...
            if (checaTipoUsuario() == "Associado")
            {
                ...
                if (ObjDbASU.MsgErro == "")
                {
                    iDAcesso = Session["codAcesso"].ToString();
                    int tCampo = iDAcesso.Length;                    

                    if (tCampo == 9 || tCampo == 11)
                    {
                        campos = " d.iddepen, a.senha, a.idassoc, a.titular AS nome, u.descricao AS unidade, depto.descricao AS Departamento, s.descricao AS Setor, a.trab_funca, b.descricao AS banco, a.sexo, a.cnpj_cpf, a.ie_rg, a.email, a.fone, a.celular, a.cep, a.endereco, a.numero, a.complement, a.bairro, a.cidade, a.estado, a.credito, a.bco_banco, a.bco_agenci, a.bco_tipocc, a.bco_conta, a.bco_digcc ";
                        tabela = " asdepen AS d ";
                        ...
                        condicao = " WHERE(d.cnpj_cpf = '" + iDAcesso + "' OR(EXISTS(SELECT NULL FROM asdepcar AS car WHERE d.iddepen = car.dependen AND car.idcartao = '" + iDAcesso.Substring(0, 7) + "'))) AND a.cnscanmom IS NULL ";
            ...
            else
            {
                ...
                iDAcesso = Session["codAcesso"].ToString();
                int tCampo = iDAcesso.Length;
                //MessageBox.Show(iDAcesso);

                campos = " * ";
                tabela = " coconven ";
                condicao = " where idconven = '" + iDAcesso.Substring(0, (tCampo - 2)) + "' ";
        ...
        public String publicidade()
        {
            ...
            if (checaTipoUsuario() == "Associado")
            {
                ...
                xRet += "<img src='../Img/Painel-Clube.jpg' />";
            }
            else
            {
                xRet += "Conveniado";
...
#pragma warning restore CS0219 // A variável "gastosPre" é atribuída, mas seu valor nunca é usado
            ...
            if (tCampo == 9)
            {
                ...
                lblMsg.Text = rDigVerifica.Substring(7, 2);
...
#pragma warning restore CS0219 // A variável "gastos" é atribuída, mas seu valor nunca é usado
        ...
        public void montarRelMensal()
        {
            ...
            if (ObjDadosLinha.MsgErro == "" || ObjDadosColuna.MsgErro == "")
            {
                ...
                {
                    xTab += "Não Gerou dados para Retorno";
                }
            }
            else
            {
                xTab += "Dados Mês: " + ObjDadosLinha.MsgErro + ", Dados Parcelas Futuras: " + ObjDadosColuna.MsgErro;
            }

            //MessageBox.Show(xRet);
            //MessageBox.Show(xTab);

            lblFaturaMensal.Text = xTab;
